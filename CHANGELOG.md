...
Packages with other changes:
 ...
 - [`page_turn_animation` - `v0.1.3`](#page_turn_animation---v013)

---

#### `page_turn_animation` - `v0.1.3`

 - **FIX**: Reverting earlier workflow changes and updating publish step ([#8](https://github.com/resengi/page_turn_animation/issues/8)). ([4780711e](https://github.com/resengi/page_turn_animation/commit/4780711e8d8fe8de89b2a1c9251e8ec8fe007efa))
